...
ClickDelayAfterMouseMove := 5
RescanDelayAfterClick := 10
DelayIfFailedClick := 150

;======    Bar Minigame Settings    ==============================================================;

AutoBarSizeMultiplier := true
RightBiasedStableMode := true

IncreaseIfCantFindWhiteBar := 65
IncreaseIfCantFindFishBar := 4.6
IncreaseIfCantFindArrow := 5.3

StableLowestDelay := 40
StableHighestDelay := 170
RightStableMultiplier := 2.8
RightStableDivision := 2.5
LeftStableMultiplier := 3.1
LeftStableDivision := 2.4

UnstableHighestDelay := 794
RightUnstableMultiplier := 2.5
RightUnstableDivision := 1.4
LeftUnstableMultiplier := 2.9
LeftUnstableDivision := 1.5

MaxHoldDuration := 1000
MaxReleaseDuration := 755
...
tooltip, Disable Higher Saturation (press m), tooltipSide, tooltip7, 7
tooltip, Disable Higher Brightness (press m), tooltipSide, tooltip8, 8
